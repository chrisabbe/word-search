...
/* Title stays “Daily Word Search” */
document.querySelector("header h1").textContent = title;

/* ⭐ New theme + tagline bindings */
document.getElementById("puzzleTheme").textContent   = theme || "";
document.getElementById("puzzleTagline").textContent = tagline || "";
