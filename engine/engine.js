/* WORD SEARCH ENGINE — CSS GRID, ANDROID SAFE, TAP + DRAG */
...
/* ========= GRID SETUP (CRITICAL FIX) ========= */
const gridEl = document.getElementById("grid");

/* Explicit constraints to stop Android Chrome overhang */
gridEl.style.gridTemplateColumns = `repeat(${gridCols}, 1fr)`;
gridEl.style.maxWidth = "100%";
gridEl.style.boxSizing = "border-box";
gridEl.style.paddingInline = "1px"; // ⭐ Android Chrome safety inset
