/* WORD SEARCH ENGINE — RESPONSIVE GRID (CSS SIZED, TAP + DRAG) */
...
/* ========= GRID SIZING (CSS-DRIVEN) ========= */
const gridEl = document.getElementById("grid");
/* Let CSS handle cell sizing; we only set the column count. */
...
/* IMPORTANT:
   We intentionally do NOT re-render or recalc sizing on resize/orientation.
   CSS handles the responsive sizing, and re-rendering breaks touch hit-testing
   on some mobile browsers + inside iframes.
*/
